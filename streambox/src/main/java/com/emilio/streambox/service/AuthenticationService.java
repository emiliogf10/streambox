 ...
 *
 * <p>Se encarga de localizar al usuario mediante su dirección de correo
 * electrónico y comprobar que la contraseña proporcionada coincide con
 * la contraseña cifrada almacenada en la base de datos.</p>
 */
@Service
public class AuthenticationService {
     ...
     * @param passwordEncoder componente utilizado para comprobar las
     ...
     *
     * <p>Primero se busca el usuario mediante su dirección de correo
     * electrónico. Si existe, se comprueba la contraseña proporcionada
     * utilizando {@link PasswordEncoder#matches(CharSequence, String)}.</p>
     *
     * <p>Por motivos de seguridad, se devuelve el mismo mensaje de error
