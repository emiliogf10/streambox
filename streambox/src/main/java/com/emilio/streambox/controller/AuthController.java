 ...
 *
 * <p>Expone los endpoints relacionados con el inicio de sesión bajo
 * la ruta {@code /api/auth}.</p>
 *
 * <p>El proceso de autenticación se delega en
 * {@link AuthenticationService}. Una vez autenticado el usuario,
 * {@link JwtService} genera un token JWT que se devuelve al cliente.</p>
 */
@RestController
